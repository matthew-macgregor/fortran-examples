...
contains
  ...
  subroutine ask_instructions
    ...
    print *, "EACH ROOM HAS 3 TUNNELS LEADING TO OTHER"
    print *, "ROOMS.  (LOOK AT  A DODECAHEDRON  TO SEE"
    print *, "HOW THIS WORKS-IF YOU  DON'T KNOW WHAT A"
    print *, "DODECAHEDRON IS, ASK SOMEONE)"
    print *, ""
    print *, "HAZARDS:"
    print *, ""
    print *, "BOTTOMLESS   PITS  -   TWO  ROOMS   HAVE"
    print *, "BOTTOMLESS  PITS IF  YOU  GO THERE<  YOU"
    print *, "FALL INTO THE PIT (& LOSE!)"
    print *, ""
    print *, "SUPER BATS - TWO  OTHER ROOMS HAVE SUPER"
    print *, "BATS. IF  YOU GO THERE, A  BAT GRABS YOU"
    print *, "AND TAKES YOU TO ANOTHER ROOM AT RANDOM."
    print *, "(WHICH MAY BE TROUBLESOME)"
    ...
    print *, "(HE HAS SUCKER FEET AND IS TOO BIG FOR A"
    print *, "BAT TO LIFT). USUALLY  HE IS ASLEEP. TWO"
    print *, "THINGS  WAKE  HIM  UP: YOU  SHOOTING  AN"
    print *, "ARROW OR YOU ENTERING HIS ROOM."
    print *, ""
    print *, "IF THE WUMPUS WAKES HE MOVES (P=.75) ONE"
    print *, "ROOM OR STAYS STILL (P=.25). AFTER THAT,"
    print *, "IF HE IS  WHERE YOU ARE, HE  EATS YOU UP"
    print *, "AND YOU LOSE!"
    print *, ""
    print *, "YOU:"
    print *, ""
    print *, "EACH  TURN  YOU  MAY  MOVE  OR  SHOOT  A"
    print *, "CROOKED ARROW."
    print *, ""
    print *, "MOVING - YOU CAN MOVE ONE ROOM (THRU ONE"
    print *, "TUNNEL)"
    print *, ""
    print *, "ARROWS - YOU HAVE  5 ARROWS. YOU LOSE IF"
    print *, "YOU RUN OUT."
    print *, ""
    print *, "EACH ARROW CAN GO 1  TO 5 ROOMS. YOU AIM"
    print *, "BY  TELLING THE  COMPUTER THE  ROOMS YOU"
    print *, "WANT THE  ARROW TO  GO TO. IF  THE ARROW"
    print *, "CAN'T  GO THAT  WAY  (IF  NO TUNNEL)  IT"
    print *, "MOVES AT RANDOM TO THE NEXT ROOM."
    print *, ""
    ...
    print *, "WARNINGS:"
    print *, ""
    print *, "WHEN YOU ARE ONE ROOM AWAY FROM A WUMPUS"
    print *, "OR HAZARD THE COMPUTER SAYS:"
    print *, ""
    print *, "  WUMPUS: 'I SMELL A WUMPUS'"
    print *, "  BAT : 'BATS'"
    print *, "  NEARBY PIT : 'I FEEL A DRAFT'"
    print *, "----------------------------------------"
    print *, ""
